...
const PILLARS = [
  { icon: Users, text: 'Live davening, chavrusas and shiurim — every single day' },
  { icon: Sparkles, text: 'A personal program that adapts to every child' },
  { icon: BookOpen, text: 'Torah that comes alive: maps, charts, interactive text' },
  { icon: HeartHandshake, text: 'A mashpia for every 10–15 talmidim' },
];
    ...
    <div className="flex min-h-dvh flex-col items-center justify-center py-10">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <span className="mx-auto mb-4 flex size-16 items-center justify-center rounded-3xl bg-primary text-primary-foreground shadow-lg shadow-primary/25">
            <GraduationCap className="size-8" />
          </span>
          <h1 className="font-serif text-4xl font-semibold tracking-tight">Online Cheder</h1>
          <p className="mt-1 text-sm font-medium text-muted-foreground">
            with Rabbi Khanukaev · Cheder Atlanta
          </p>
          <p dir="rtl" className="mt-3 text-lg text-accent-foreground">
